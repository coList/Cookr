...
def recipeList():
    ...
    recipes = db(db.recipe).select(limitby=(startValue, endValue))
...
# Click on "Bearbeiten"/"Edit" Button: redirect to editRecipe/<recipe.id>
def editRecipeButton():
    redirect(URL('editRecipe', args=(4), vars=()))
    return "Edit"
